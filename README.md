...
また、フロントエンドは会社に勤めている間はお手上げ状態だったのですが、CSSフレームワークをいくつか使い、フレームワークに共通する概念やパターンも理解し、たとえ他のフレームワークであったとしても開発に使えます。また言語に限らずとも、ApacheやDocker、Node.js、PostgreSQL、MySQL等使ったことがなかった技術を学び、開発に使っています。  
